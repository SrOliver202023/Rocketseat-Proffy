...
CREATE TABLE [dbo].[Class] (
    [id] NVARCHAR(1000) NOT NULL,
    [matter] NVARCHAR(1000) NOT NULL,
    [description] NVARCHAR(1000) NOT NULL,
    [price] FLOAT(53) NOT NULL,
    [userId] NVARCHAR(1000) NOT NULL,
    [scheduleId] NVARCHAR(1000),
...
-- AddForeignKey
ALTER TABLE [dbo].[Class] ADD CONSTRAINT [Class_userId_fkey] FOREIGN KEY ([userId]) REFERENCES [dbo].[User]([id]) ON DELETE NO ACTION ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE [dbo].[Schedule] ADD CONSTRAINT [Schedule_classId_fkey] FOREIGN KEY ([classId]) REFERENCES [dbo].[Class]([id]) ON DELETE SET NULL ON UPDATE CASCADE;
